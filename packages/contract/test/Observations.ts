...
describe("Observations", async function () {
  ...
  it("Should emit an Observation event", async function () {
    ...
    await viem.assertions.emitWithArgs(
      ...
      observations,
      "Observation",
      [collection, tokenId, getAddress(walletClient.account.address), "Beautiful piece.", false, 0, 0, 0, 0],
    );
  });
  ...
  it("Should emit a located Observation event", async function () {
    ...
    await viem.assertions.emitWithArgs(
      ...
      observations,
      "Observation",
      [collection, tokenId, getAddress(walletClient.account.address), "Detail in the corner.", true, 120, 340, 0, 0],
    );
  });
  ...
  it("Should emit an Observation event with animation view", async function () {
    ...
    await viem.assertions.emitWithArgs(
      ...
      observations,
      "Observation",
      [collection, tokenId, getAddress(walletClient.account.address), "Fluid motion.", false, 0, 0, 1, 0],
    );
  });
  ...
  it("Should emit a located Observation event with animation view", async function () {
    ...
    await viem.assertions.emitWithArgs(
      ...
      observations,
      "Observation",
      [collection, tokenId, getAddress(walletClient.account.address), "Movement here.", true, 50, 75, 1, 0],
    );
  });
